...
func (a GroupsApi) CreateAccountExtensionContactGroup(accountId int32, extensionId int32, data CreateGroupParams) (*GroupFull, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/accounts/{account_id}/extensions/{extension_id}/contact-groups"
	...
	var localVarAPIResponse = &APIResponse{Operation: "CreateAccountExtensionContactGroup", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a GroupsApi) DeleteAccountExtensionContactGroup(accountId int32, extensionId int32, groupId int32) (*DeleteGroup, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/accounts/{account_id}/extensions/{extension_id}/contact-groups/{group_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"account_id"+"}", fmt.Sprintf("%v", accountId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"extension_id"+"}", fmt.Sprintf("%v", extensionId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "DeleteAccountExtensionContactGroup", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a GroupsApi) GetAccountExtensionContactGroup(accountId int32, extensionId int32, groupId int32) (*GroupFull, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GetAccountExtensionContactGroup", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a GroupsApi) ListAccountExtensionContactGroups(accountId int32, extensionId int32, filtersId []string, filtersName []string, sortId string, sortName string, limit int32, offset int32, fields string) (*ListGroups, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ListAccountExtensionContactGroups", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a GroupsApi) ReplaceAccountExtensionContactGroup(accountId int32, extensionId int32, groupId int32, data CreateGroupParams) (*GroupFull, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ReplaceAccountExtensionContactGroup", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
