Phone.com CLI Tool Readme File
...
2. Swagger definition & CLI
===========================

The swagger definition that describes the Phone.com API was developed in an earlier stage. 

The Swagger definition describes the API endpoints defined at https://apidocs.phone.com from 01.01.2017.

The CLI tool uses the generated Swagger client for the Go programming language.
There were 2 known bugs encountered for the generated Go client while developing the CLI. One is the duplication of the var collectionFormat = "multi" variable. 
...
The Òphonecom-go-sdkÓ package contains all the generated swagger code along with the documentation in a form of README file and *.md files.
The ÒphonecomÓ package contains the code that adapts the generated Swagger code for the CLI.


4. Libraries
============

There were 2 Go libraries that were used while developing the code. This libraries can be installed with go in the following way:
...
The ÒGetÓ command can be invoked in two ways:
