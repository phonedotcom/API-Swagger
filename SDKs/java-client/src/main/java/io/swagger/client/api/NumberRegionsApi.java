...
public class NumberRegionsApi {
     ...
     * @param fields Field set (optional)
     * @param groupBy Fields to group by (supports the same set of fields as the filters and sorting) (optional)
     * @return ApiResponse&lt;ListPhoneNumbersRegions&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ListPhoneNumbersRegions> listAvailablePhoneNumberRegionsWithHttpInfo(List<String> filtersCountryCode, List<String> filtersNpa, List<String> filtersNxx, List<String> filtersIsTollFree, List<String> filtersCity, List<String> filtersProvincePostalCode, List<String> filtersCountryPostalCode, String sortCountryCode, String sortNpa, String sortNxx, String sortIsTollFree, String sortCity, String sortProvincePostalCode, String sortCountryPostalCode, Integer limit, Integer offset, String fields, List<String> groupBy) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<ListPhoneNumbersRegions>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call listAvailablePhoneNumberRegionsAsync(List<String> filtersCountryCode, List<String> filtersNpa, List<String> filtersNxx, List<String> filtersIsTollFree, List<String> filtersCity, List<String> filtersProvincePostalCode, List<String> filtersCountryPostalCode, String sortCountryCode, String sortNpa, String sortNxx, String sortIsTollFree, String sortCity, String sortProvincePostalCode, String sortCountryPostalCode, Integer limit, Integer offset, String fields, List<String> groupBy, final ApiCallback<ListPhoneNumbersRegions> callback) throws ApiException {
