...
public class CallLogsApi {
    ...
    /* Build call for getAccountCallLogs */
    private com.squareup.okhttp.Call getAccountCallLogsCall(Integer accountId, String callId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/accounts/{account_id}/call-logs/{call_id}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "account_id" + "\\}", apiClient.escapeString(accountId.toString()))
        .replaceAll("\\{" + "call_id" + "\\}", apiClient.escapeString(callId.toString()));
    ...
    private com.squareup.okhttp.Call getAccountCallLogsValidateBeforeCall(Integer accountId, String callId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'accountId' is set
        if (accountId == null) {
            throw new ApiException("Missing the required parameter 'accountId' when calling getAccountCallLogs(Async)");
        }
        
        // verify the required parameter 'callId' is set
        if (callId == null) {
            throw new ApiException("Missing the required parameter 'callId' when calling getAccountCallLogs(Async)");
        }
        
        
        com.squareup.okhttp.Call call = getAccountCallLogsCall(accountId, callId, progressListener, progressRequestListener);
        return call;
     ...
     */
    public CallLogFull getAccountCallLogs(Integer accountId, String callId) throws ApiException {
        ApiResponse<CallLogFull> resp = getAccountCallLogsWithHttpInfo(accountId, callId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CallLogFull> getAccountCallLogsWithHttpInfo(Integer accountId, String callId) throws ApiException {
        com.squareup.okhttp.Call call = getAccountCallLogsValidateBeforeCall(accountId, callId, null, null);
     ...
     */
    public com.squareup.okhttp.Call getAccountCallLogsAsync(Integer accountId, String callId, final ApiCallback<CallLogFull> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAccountCallLogsValidateBeforeCall(accountId, callId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CallLogFull>(){}.getType();
    ...
    public ListCallLogs listAccountCallLogs(Integer accountId, List<String> filtersId, List<String> filtersStartTime, String filtersCreatedAt, String filtersDirection, String filtersCalledNumber, String filtersType, List<String> filtersExtension, String sortId, String sortStartTime, String sortCreatedAt, Integer limit, Integer offset, String fields) throws ApiException {
        ApiResponse<ListCallLogs> resp = listAccountCallLogsWithHttpInfo(accountId, filtersId, filtersStartTime, filtersCreatedAt, filtersDirection, filtersCalledNumber, filtersType, filtersExtension, sortId, sortStartTime, sortCreatedAt, limit, offset, fields);
        return resp.getData();
    }
     ...
     * @param offset Results to skip (optional)
     * @param fields Field set (optional)
     * @return ApiResponse&lt;ListCallLogs&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ListCallLogs> listAccountCallLogsWithHttpInfo(Integer accountId, List<String> filtersId, List<String> filtersStartTime, String filtersCreatedAt, String filtersDirection, String filtersCalledNumber, String filtersType, List<String> filtersExtension, String sortId, String sortStartTime, String sortCreatedAt, Integer limit, Integer offset, String fields) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<ListCallLogs>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listAccountCallLogsAsync(Integer accountId, List<String> filtersId, List<String> filtersStartTime, String filtersCreatedAt, String filtersDirection, String filtersCalledNumber, String filtersType, List<String> filtersExtension, String sortId, String sortStartTime, String sortCreatedAt, Integer limit, Integer offset, String fields, final ApiCallback<ListCallLogs> callback) throws ApiException {
