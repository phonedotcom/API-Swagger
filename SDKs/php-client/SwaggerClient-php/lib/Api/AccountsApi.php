...
class AccountsApi
{
     ...
     */
    public function listAccounts($filters_id = null, $sort_id = null, $limit = null, $offset = null, $fields = null)
    {
        list($response) = $this->listAccountsWithHttpInfo($filters_id, $sort_id, $limit, $offset, $fields);
        return $response;
    }
     ...
     */
    public function listAccountsWithHttpInfo($filters_id = null, $sort_id = null, $limit = null, $offset = null, $fields = null)
    {
        if (!is_null($sort_id) && !preg_match("/asc|desc/", $sort_id)) {
            throw new \InvalidArgumentException("invalid value for \"sort_id\" when calling AccountsApi.listAccounts, must conform to the pattern /asc|desc/.");
        }
