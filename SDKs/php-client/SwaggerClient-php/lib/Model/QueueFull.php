 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class QueueFull implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QueueFull';
    ...
    protected static $swaggerTypes = [
        ...
        'hold_music' => '\Swagger\Client\Model\HoldMusic',
        'max_hold_time' => 'int',
    ...
    /**
     * Sets greeting
     * @param \Swagger\Client\Model\MediaSummary $greeting Greeting to be played when caller first connects. Output is a Media Summary Object. Input must be a Media Lookup Object. Must refer to a media recording that has is_hold_music set to FALSE. Can be set to NULL to disable the greeting.
     * @return $this
     */
    ...
    /**
     * Gets hold_music
     * @return \Swagger\Client\Model\HoldMusic
     */
    ...
    /**
     * Sets hold_music
     * @param \Swagger\Client\Model\HoldMusic $hold_music
     * @return $this
     */
    ...
    /**
     * Sets max_hold_time
     * @param int $max_hold_time Maximum hold time in seconds. If provided, must equal one of: 60, 120, 180, 240, 300, 600, 900, 1200, 1800, 2700, 3600. Default is 300.
     * @return $this
     */
    ...
    /**
     * Sets caller_id_type
     * @param string $caller_id_type Caller id type to show members. If provided, must equal one of: 'called_number', 'calling_number'. Default is 'calling_number'.
     * @return $this
     */
    ...
    /**
     * Sets ring_time
     * @param int $ring_time Number of seconds to ring a member before cycling to the next member. If provided, must equal one of: 5, 10, 15, 20, 25, 30. Default is 5.
     * @return $this
     */
    ...
    /**
     * Sets members
     * @param \Swagger\Client\Model\Member[] $members Array of Member Objects. Non-virtual account extensions or phone numbers. See below for details.
     * @return $this
     */
