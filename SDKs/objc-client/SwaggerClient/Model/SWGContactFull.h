...
@protocol SWGContactFull
@end

@interface SWGContactFull : SWGObject
...
/* Phonetic first name. Useful for remembering how to pronounce the contact's name. [optional]
 */
@property(nonatomic) NSString* phoneticFirstName;
/* Phonetic middle name. Useful for remembering how to pronounce the contact's name. [optional]
 */
@property(nonatomic) NSString* phoneticMiddleName;
/* Phonetic last name. Useful for remembering how to pronounce the contact's name. [optional]
 */
@property(nonatomic) NSString* phoneticLastName;
/* Name of the contact's department [optional]
 */
@property(nonatomic) NSString* department;
/* Contact's job title [optional]
 */
@property(nonatomic) NSString* jobTitle;
/* Array of Contact Email Objects. See below for details. [optional]
 */
...
/* Array of Contact Address Objects. See below for details. [optional]
 */
@property(nonatomic) NSArray<SWGAddressListContacts>* addresses;

@property(nonatomic) SWGGroupListContacts* group;
/* Integer UNIX timestamp when the contact was created. Read-only. [optional]
 */
