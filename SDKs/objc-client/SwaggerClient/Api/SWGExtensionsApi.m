...
@interface SWGExtensionsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGExtensionsApi

NSString* kSWGExtensionsApiErrorDomain = @"SWGExtensionsApiErrorDomain";
NSInteger kSWGExtensionsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createAccountExtensionWithAccountId: (NSNumber*) accountId
    ...
    if (accountId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGExtensionsApiErrorDomain code:kSWGExtensionsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGExtensionFull*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGExtensionFull*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) listAccountExtensionsWithAccountId: (NSNumber*) accountId
    ...
    if (sortExtension != nil) {
        queryParams[@"sort[extension]"] = sortExtension;
    }
    if (sortName != nil) {
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGListExtensions*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGListExtensions*)data, error);
                                }
                            }];
}
