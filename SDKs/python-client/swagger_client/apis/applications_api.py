...
class ApplicationsApi(object):
    ...
    def get_account_application(self, account_id, application_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_account_application(account_id, application_id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_account_application_with_http_info(account_id, application_id, **kwargs)
        else:
            (data) = self.get_account_application_with_http_info(account_id, application_id, **kwargs)
            return data
    ...
    def get_account_application_with_http_info(self, account_id, application_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_account_application_with_http_info(account_id, application_id, callback=callback_function)
        ...
        all_params = ['account_id', 'application_id']
        ...
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `get_account_application`")
        # verify the required parameter 'application_id' is set
        if ('application_id' not in params) or (params['application_id'] is None):
            raise ValueError("Missing the required parameter `application_id` when calling `get_account_application`")
    ...
    def list_account_applications(self, account_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_account_applications(account_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_account_applications_with_http_info(account_id, **kwargs)
        else:
            (data) = self.list_account_applications_with_http_info(account_id, **kwargs)
            return data
    ...
    def list_account_applications_with_http_info(self, account_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_account_applications_with_http_info(account_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_account_applications" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `list_account_applications`")

        if 'sort_id' in params and not re.search('asc|desc', params['sort_id']):
            raise ValueError("Invalid value for parameter `sort_id` when calling `list_account_applications`, must conform to the pattern `/asc|desc/`")
        if 'sort_name' in params and not re.search('asc|desc', params['sort_name']):
            raise ValueError("Invalid value for parameter `sort_name` when calling `list_account_applications`, must conform to the pattern `/asc|desc/`")
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ListApplications',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
