...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateMenuParams :  IEquatable<CreateMenuParams>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateMenuParams);
        }

        /// <summary>
        /// Returns true if CreateMenuParams instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateMenuParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateMenuParams other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
