...
namespace IO.Swagger.Model
{
    ...
    public partial class MenuSummary :  IEquatable<MenuSummary>, IValidatableObject
    {
        ...
        public MenuSummary(int? Id = default(int?), string Name = default(string))
        {
            this.Id = Id;
            this.Name = Name;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MenuSummary);
        }

        /// <summary>
        /// Returns true if MenuSummary instances are equal
        /// </summary>
        /// <param name="other">Instance of MenuSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MenuSummary other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
