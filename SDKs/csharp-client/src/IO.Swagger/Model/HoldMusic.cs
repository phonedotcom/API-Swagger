...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HoldMusic :  IEquatable<HoldMusic>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HoldMusic" /> class.
        /// </summary>
        /// <param name="Id">Recording ID. Read-only..</param>
        /// <param name="Name">Name of recording.</param>
        public HoldMusic(int? Id = default(int?), string Name = default(string))
        {
            this.Id = Id;
            this.Name = Name;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HoldMusic);
        }

        /// <summary>
        /// Returns true if HoldMusic instances are equal
        /// </summary>
        /// <param name="other">Instance of HoldMusic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HoldMusic other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
