...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SortIdExtensionName :  IEquatable<SortIdExtensionName>, IValidatableObject
    {
        /// <summary>
        ...
        public SortIdExtensionName(string Id = default(string), string Extension = default(string), string Name = default(string))
        {
            this.Id = Id;
