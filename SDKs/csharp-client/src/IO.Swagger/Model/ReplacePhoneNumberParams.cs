...
namespace IO.Swagger.Model
{
    ...
    public partial class ReplacePhoneNumberParams :  IEquatable<ReplacePhoneNumberParams>, IValidatableObject
    {
        ...
        public ReplacePhoneNumberParams(Object Route = default(Object), string Name = default(string), bool? BlockIncoming = default(bool?), bool? BlockAnonymous = default(bool?), string CallerIdName = default(string), string CallerIdType = default(string), string SmsForwardingType = default(string), Object SmsForwardingApplication = default(Object), Object SmsForwardingExtension = default(Object), Object PoolItem = default(Object), List<string> CallNotificationsEmails = default(List<string>), string CallNotificationsSms = default(string))
        {
            this.Route = Route;
            this.Name = Name;
