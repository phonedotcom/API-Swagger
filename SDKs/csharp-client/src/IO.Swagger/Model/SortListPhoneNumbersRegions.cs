...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SortListPhoneNumbersRegions :  IEquatable<SortListPhoneNumbersRegions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SortListPhoneNumbersRegions" /> class.
        /// </summary>
        ...
        public SortListPhoneNumbersRegions(string CountryCode = default(string), string Npa = default(string), string Nxx = default(string), string IsTollFree = default(string), string City = default(string), string ProvincePostalCode = default(string), string CountryPostalCode = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SortListPhoneNumbersRegions);
        }

        /// <summary>
        /// Returns true if SortListPhoneNumbersRegions instances are equal
        /// </summary>
        /// <param name="other">Instance of SortListPhoneNumbersRegions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SortListPhoneNumbersRegions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
