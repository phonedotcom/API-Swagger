...
module SwaggerClient
  class MenusApi
    ...
    def create_account_menu_with_http_info(account_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'account_id' when calling MenusApi.create_account_menu" if account_id.nil?
      # resource path
      local_var_path = "/accounts/{account_id}/menus".sub('{format}','json').sub('{' + 'account_id' + '}', account_id.to_s)
    ...
    # @param menu_id Menu ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(DeleteMenu, Fixnum, Hash)>] DeleteMenu data, response status code and response headers
    def delete_account_menu_with_http_info(account_id, menu_id, opts = {})
      ...
      # verify the required parameter 'account_id' is set
      fail ArgumentError, "Missing the required parameter 'account_id' when calling MenusApi.delete_account_menu" if account_id.nil?
      # verify the required parameter 'menu_id' is set
      fail ArgumentError, "Missing the required parameter 'menu_id' when calling MenusApi.delete_account_menu" if menu_id.nil?
      # resource path
      local_var_path = "/accounts/{account_id}/menus/{menu_id}".sub('{format}','json').sub('{' + 'account_id' + '}', account_id.to_s).sub('{' + 'menu_id' + '}', menu_id.to_s)
    ...
    def get_account_menu_with_http_info(account_id, menu_id, opts = {})
      ...
      # verify the required parameter 'account_id' is set
      fail ArgumentError, "Missing the required parameter 'account_id' when calling MenusApi.get_account_menu" if account_id.nil?
      # verify the required parameter 'menu_id' is set
      fail ArgumentError, "Missing the required parameter 'menu_id' when calling MenusApi.get_account_menu" if menu_id.nil?
      # resource path
      local_var_path = "/accounts/{account_id}/menus/{menu_id}".sub('{format}','json').sub('{' + 'account_id' + '}', account_id.to_s).sub('{' + 'menu_id' + '}', menu_id.to_s)
    ...
    def list_account_menus_with_http_info(account_id, opts = {})
      ...
      # verify the required parameter 'account_id' is set
      fail ArgumentError, "Missing the required parameter 'account_id' when calling MenusApi.list_account_menus" if account_id.nil?
    ...
    def replace_account_menu_with_http_info(account_id, menu_id, opts = {})
      ...
      # verify the required parameter 'account_id' is set
      fail ArgumentError, "Missing the required parameter 'account_id' when calling MenusApi.replace_account_menu" if account_id.nil?
      # verify the required parameter 'menu_id' is set
      fail ArgumentError, "Missing the required parameter 'menu_id' when calling MenusApi.replace_account_menu" if menu_id.nil?
      # resource path
      local_var_path = "/accounts/{account_id}/menus/{menu_id}".sub('{format}','json').sub('{' + 'account_id' + '}', account_id.to_s).sub('{' + 'menu_id' + '}', menu_id.to_s)
