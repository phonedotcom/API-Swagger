...
module SwaggerClient
  ...
  class AccountFull
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'master_account')
        self.master_account = attributes[:'master_account']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          username == o.username &&
          password == o.password &&
          master_account == o.master_account &&
          contact == o.contact &&
    ...
    def hash
      [id, name, username, password, master_account, contact, billing_contact].hash
    end
