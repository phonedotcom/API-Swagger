...
module SwaggerClient
  ...
  class QueueFull
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'max_hold_time')
        self.max_hold_time = attributes[:'max_hold_time']
      end

      if attributes.has_key?(:'caller_id_type')
        self.caller_id_type = attributes[:'caller_id_type']
      end

      if attributes.has_key?(:'ring_time')
        self.ring_time = attributes[:'ring_time']
      end
    ...
    def hash
      [id, name, greeting, hold_music, max_hold_time, caller_id_type, ring_time, members].hash
    end
