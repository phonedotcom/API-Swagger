...
module SwaggerClient
  ...
  class RuleSetFilter
    ...
    def list_invalid_properties
      ...
      if !@type.nil? && @type !~ Regexp.new(/schedule|contact|contact_group/)
        invalid_properties.push("invalid value for 'type', must conform to the pattern /schedule|contact|contact_group/.")
      end
    ...
    def valid?
      return false if !@type.nil? && @type !~ Regexp.new(/schedule|contact|contact_group/)
      return true
    end
    ...
    def type=(type)
      ...
      if !type.nil? && type !~ Regexp.new(/schedule|contact|contact_group/)
        fail ArgumentError, "invalid value for 'type', must conform to the pattern /schedule|contact|contact_group/."
      end
    ...
    def hash
      [type, schedule, contact, group].hash
    end
