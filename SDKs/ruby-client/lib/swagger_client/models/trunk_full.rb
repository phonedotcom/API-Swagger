...
module SwaggerClient
  ...
  class TrunkFull
    ...
    attr_accessor :max_minutes_per_month
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'max_concurrent_calls')
        self.max_concurrent_calls = attributes[:'max_concurrent_calls']
      end

      if attributes.has_key?(:'max_minutes_per_month')
        self.max_minutes_per_month = attributes[:'max_minutes_per_month']
      end
    ...
    def list_invalid_properties
      ...
      if @max_concurrent_calls.nil?
        invalid_properties.push("invalid value for 'max_concurrent_calls', max_concurrent_calls cannot be nil.")
      end

      if @max_minutes_per_month.nil?
        invalid_properties.push("invalid value for 'max_minutes_per_month', max_minutes_per_month cannot be nil.")
      end

      if @greeting.nil?
        invalid_properties.push("invalid value for 'greeting', greeting cannot be nil.")
      end
      ...
      if @codecs.nil?
        invalid_properties.push("invalid value for 'codecs', codecs cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @max_concurrent_calls.nil?
      return false if @max_minutes_per_month.nil?
      return false if @greeting.nil?
      return false if @error_message.nil?
      return false if @codecs.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          max_minutes_per_month == o.max_minutes_per_month &&
          greeting == o.greeting &&
    ...
    def hash
      [id, name, uri, max_concurrent_calls, max_minutes_per_month, greeting, error_message, codecs].hash
    end
