...
module SwaggerClient
  ...
  class ReplaceMenuParams
    attr_accessor :name

    attr_accessor :greeting

    attr_accessor :invalid_keypress
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'invalid_keypress')
        self.invalid_keypress = attributes[:'invalid_keypress']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          greeting == o.greeting &&
          invalid_keypress == o.invalid_keypress &&
    ...
    def hash
      [name, greeting, invalid_keypress, allow_extension_dial, keypress_wait_time, timeout_handler, options].hash
    end
