...
module SwaggerClient
  ...
  class CreateMenuParams
    ...
    attr_accessor :main_message

    attr_accessor :invalid_keypress_message
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'main_message')
        self.main_message = attributes[:'main_message']
      end

      if attributes.has_key?(:'invalid_keypress_message')
        self.invalid_keypress_message = attributes[:'invalid_keypress_message']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          invalid_keypress_message == o.invalid_keypress_message &&
    ...
    def hash
      [name, main_message, invalid_keypress_message, allow_extension_dial, keypress_wait_time, timeout_handler, options].hash
    end
