  ...
  class ReplaceExtensionParams
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'route')
        if (value = attributes[:'route']).is_a?(Array)
          self.route = value
        end
      end
    ...
    def hash
      [voicemail_greeting_alternate, name_greeting, name, timezone, include_in_directory, extension, enable_outbound_calls, usage_type, voicemail_password, full_name, enable_call_waiting, voicemail_greeting_standard, voicemail_greeting_type, caller_id, local_area_code, voicemail_enabled, voicemail_greeting_enable_leave_message_prompt, voicemail_transcription, voicemail_notifications_emails, voicemail_notifications_sms, call_notifications_emails, call_notifications_sms, route].hash
    end
