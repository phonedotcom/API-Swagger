...
module SwaggerClient
  ...
  class ContactSubaccount
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'primary_email')
        self.primary_email = attributes[:'primary_email']
      end

      if attributes.has_key?(:'alternate_email')
    ...
    def hash
      [name, address, primary_email, alternate_email, company, phone, fax].hash
    end
