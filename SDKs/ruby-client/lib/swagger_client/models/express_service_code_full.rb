...
module SwaggerClient
  ...
  class ExpressServiceCodeFull
    # ID
    attr_accessor :id

    # An 8-digit number in string format
    attr_accessor :express_service_code
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'express_service_code')
        self.express_service_code = attributes[:'express_service_code']
      end

      if attributes.has_key?(:'expire_date')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          express_service_code == o.express_service_code &&
    ...
    def hash
      [id, express_service_code, expire_date].hash
    end
