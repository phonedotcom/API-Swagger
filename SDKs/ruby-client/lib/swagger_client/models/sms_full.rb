...
module SwaggerClient
  ...
  class SmsFull
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'created_epoch')
        self.created_epoch = attributes[:'created_epoch']
      end
    ...
    def list_invalid_properties
      ...
      if @created_epoch.nil?
        invalid_properties.push("invalid value for 'created_epoch', created_epoch cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @created_epoch.nil?
    ...
    def hash
      [id, from, to, direction, created_epoch, created_at, text].hash
    end
