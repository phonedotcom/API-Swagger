...
module SwaggerClient
  ...
  class CreateContactParams
    ...
    def hash
      [first_name, middle_name, last_name, prefix, phonetic_first_name, phonetic_middle_name, phonetic_last_name, suffix, nickname, company, department, job_title, emails, phone_numbers, addresses, group].hash
    end
