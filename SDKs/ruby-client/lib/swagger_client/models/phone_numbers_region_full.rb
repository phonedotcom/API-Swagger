...
module SwaggerClient
  ...
  class PhoneNumbersRegionFull
    ...
    attr_accessor :province_postal_code

    # Optional. Two-letter postal code for the country.
    attr_accessor :country_postal_code
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'province_postal_code')
        self.province_postal_code = attributes[:'province_postal_code']
      end

      if attributes.has_key?(:'country_postal_code')
        self.country_postal_code = attributes[:'country_postal_code']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          city == o.city &&
          province_postal_code == o.province_postal_code &&
          country_postal_code == o.country_postal_code &&
          quantity == o.quantity
    end
    ...
    def hash
      [country_code, npa, nxx, is_toll_free, city, province_postal_code, country_postal_code, quantity].hash
    end
