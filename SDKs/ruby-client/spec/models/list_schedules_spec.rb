...
# Unit tests for SwaggerClient::ListSchedules
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListSchedules' do
  before do
    # run before each test
    @instance = SwaggerClient::ListSchedules.new
  end
  ...
  describe 'test an instance of ListSchedules' do
    it 'should create an instact of ListSchedules' do
      expect(@instance).to be_instance_of(SwaggerClient::ListSchedules)
    end
  end
